      ...
      .row.justify-content-center.align-items-center.mb-5
        .col-lg-6
           LineaTiempoD.color-acento-botones.mb-4
            p.text-small(numero="1" titulo="Valores nulos o ausentes") Se presentan cuando falta información en una o más variables de ciertos registros. Por ejemplo, una base de datos de clientes podría tener campos vacíos en la dirección de correo electrónico o en la fecha de nacimiento, lo cual limita su utilidad para análisis o segmentación.
                ...
                tr
                  ...
                  td 
                    ...
                    ul.lista-ul--color
                      li
                        i.fas.fa-angle-right
                        | Unicidad: existencia de registros duplicados que deberían ser únicos, como dos clientes con el mismo número de identificación.
                      li
                        i.fas.fa-angle-right
                        | Integridad referencial: claves foráneas sin correspondencia, lo que rompe las relaciones entre tablas.
                      li
                        i.fas.fa-angle-right
                        | Otras restricciones: definiciones inadecuadas de dominios, reglas de validación ausentes, entre otros.	
                  td 
                    p Relacionados con los valores específicos almacenados, frecuentemente causados por errores de entrada o procesamiento:
                      ul.lista-ul--color
                        li
                          i.fas.fa-angle-right
                          | Errores ortográficos: por ejemplo, escribir “Colmbia” en lugar de “Colombia”.
                        li
                          i.fas.fa-angle-right
                          | Registros duplicados: redundancia de información que puede afectar el análisis.
                        li
                          i.fas.fa-angle-right
                          | Valores contradictorios: dos fechas de nacimiento distintas para un mismo individuo.
                        li
                          i.fas.fa-angle-right
                          | Otros: valores fuera de rango, campos vacíos, formatos incorrectos.
                tr
                  ...
                  td  
                    ...
                    ul.lista-ul--color
                      li
                        i.fas.fa-angle-right
                        | Conflictos de nombres: como “CustomerID” frente a “ClientCode” para referirse al mismo concepto.
                      li
                        i.fas.fa-angle-right
                        | Conflictos estructurales: una misma entidad representada como tabla en una fuente y como objeto en otra.
                      li
                        i.fas.fa-angle-right
                        | Otras diferencias: uso de distintos tipos de datos, estructuras jerárquicas frente a relacionales, etc.	
                  td
                    p Aparecen en los valores concretos provenientes de diversas fuentes:
                      ul.lista-ul--color
                        li
                          i.fas.fa-angle-right
                          | Agregación inconsistente: por ejemplo, una fuente muestra totales mensuales y la otra diarios.
                        li
                          i.fas.fa-angle-right
                          | Desincronización temporal: los datos provienen de momentos distintos, generando incoherencias.
                        li
                          i.fas.fa-angle-right
                          | Otros: datos faltantes en alguna fuente, formatos incompatibles, distintas unidades de medida.
          ...
          .col-lg-10
            SlyderF.mb-5(columnas="col-lg-6 col-xl-4")
              ...
              .tarjeta.tarjeta--BG01.color-primario.p-4
                ...
                p Se puede realizar mediante técnicas estadísticas como el rango intercuartílico, el Z-score, o modelando estos valores de forma separada si son representativos.
